      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAPHR3kGg:APA91bGvfaVYY_QFecjqPjiatq7xfBSoGoC2RwcNqvVVkIhbRp9TU85pPFysfcl9pC3aqp122rgnSqQJgA5GTFzXzMgL8Jty_CtJVTGJLwW_vL5BeXEO61p2xKlUePsixgRw15tTVFi7'
          },
...
// Assuming `email` is the email of the user you want to delete
  ...
  // Method to delete all chats at once
  // Method to delete all messages within a collection
  static Future<void> deleteAllMessagesInConversation(ChatUser user) async {
    try {
